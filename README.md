...
<img width="1858" height="840" alt="изображение" src="https://github.com/user-attachments/assets/d8dc9ab5-a6aa-49ad-be36-a0b05fb01eed" />
- Backend - принимает запросы по API, записывает информацию в Postgres, отправляет ревью в очередь воркера
- Frontend - UI
- Worker - Пайплайн классификации рецензий, получает на вход рецензию, классифицирует и обновляет информацию в БД
- MLflow - Отвечает за версионирование модели и постановку экперементов
- Minio - Отвечает за хранение модели
- RabbitMQ - Брокер сообщений
- Promehteus & Grafana - Мониторинг состояния приложения и кластера
Сопутствующие элементы:
- Adminer - UI для Postgres
- ArgoCD - Обновление манифестов на сервере при пуше в main
- NodeExporter - сбор состояния железа
